...
raw_inflow_data <- read.table(file="/home/guest/TSA_Sp25/Data/inflowtimeseries.txt",header=FALSE,skip=0)
...
linear_trend_model=lm(inflow_data[, iHP+1] ~t) # +1 refers to the data column
